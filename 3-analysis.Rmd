...
```{r measures1}
displayMultiMeasure(selectedALS,dynamic_indiv,dynamic_total,static_data,windows=c(1,3,5),measures=c('prob.joint','pmi','nmi'),excludeConceptsFromName = 'D000690')
```
...
```{r trend.distrib}
l<-displayTrendDistribution(relations.ma,indiv.ma)
l$x0.y0
l$x0.y1
l$x1.y0
l$x1.y1
