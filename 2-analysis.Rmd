...
```{r eval.create.data.to.annotate1}
...
```{r eval.create.data.to.annotate2}
set.seed(2022) 
...
```{r eval.create.data.to.annotate3}
...
```{r eval.results1}
res <- eval.baselinefunction( x1, y1, x2, y2, annotFile='data/annotated-relations.tsv') 
kable(res)
```
